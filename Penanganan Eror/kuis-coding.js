...
const argumenPertamaTidakValid = detectTriangle('a', 3, 5);
const argumenKeduaTidakValid = detectTriangle(1, false, 1);
const argumenKetigaTidakValid = detectTriangle(12, 2, null);

console.log(segitigaSamaSisi);
console.log(segitigaSamaKaki);
console.log(segitigaSembarang);
console.log(argumenPertamaTidakValid);
console.log(argumenKeduaTidakValid);
console.log(argumenKetigaTidakValid);